...
void MultiProgramAbstractionGraph::VertexTraversal(
    void (*CALL_BACK_FUNC)(MultiProgramAbstractionGraph *, int, void *),
    void *extra) {
  igraph_vs_t vs;
  igraph_vit_t vit;
...
igraph_bool_t mpag_in_callback(const igraph_t *graph, igraph_integer_t vid,
                               igraph_integer_t dist, void *extra) {
  struct mpag_dfs_call_back_t *extra_wrapper =
      (struct mpag_dfs_call_back_t *)extra;
...
igraph_bool_t mpag_out_callback(const igraph_t *graph, igraph_integer_t vid,
                                igraph_integer_t dist, void *extra) {
  struct mpag_dfs_call_back_t *extra_wrapper =
      (struct mpag_dfs_call_back_t *)extra;
...
void MultiProgramAbstractionGraph::DFS(
    type::vertex_t root,
    void (*IN_CALL_BACK_FUNC)(MultiProgramAbstractionGraph *, int, void *),
    void (*OUT_CALL_BACK_FUNC)(MultiProgramAbstractionGraph *, int, void *),
    void *extra) {
  // MultiProgramAbstractionGraph* new_graph = new
  // MultiProgramAbstractionGraph(); new_graph->GraphInit();
  struct mpag_dfs_call_back_t *extra_wrapper =
      new (struct mpag_dfs_call_back_t)();
  ...
  igraph_dfs(&(this->ipag_->graph), /*root=*/root, /*neimode=*/IGRAPH_OUT,
             ...
             /*father=*/0, /*dist=*/0,
             /*in_callback=*/mpag_in_callback,
             /*out_callback=*/mpag_out_callback, /*extra=*/extra_wrapper);
  ///*in_callback=*/0, /*out_callback=*/0, /*extra=*/extra_wrapper);
}

void MultiProgramAbstractionGraph::SetPagToMpagMap(
  ...
  this->j_pag_to_mpag_map[pag_vertex_id_str][process_id_str][thread_id_str] =
      mpag_vertex_id;
}
